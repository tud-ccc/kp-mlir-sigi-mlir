...
module @check_1captureArg {
    ...
    func.func @main() {
        ...
        // CHECK-DAG: %[[ALLOC:.+]] = llvm.call @malloc(%{{.+}}) : (i64) -> !llvm.ptr<i8>
        ...
        // CHECK-DAG: %[[STOREPTR:.+]] = llvm.bitcast %[[ALLOC]] : !llvm.ptr<i8> to !llvm.ptr<struct<([[FPTR]], struct<(i32)>)>>
        // CHECK-DAG: llvm.store %[[STRUCT1]], %[[STOREPTR]] : !llvm.ptr<struct<([[FPTR]], struct<(i32)>)>>
        // CHECK-DAG: %[[CAST_CLOSURE:.+]] = llvm.bitcast %[[ALLOC]] : !llvm.ptr<i8> to !llvm.ptr<[[FPTR]]>
        ...
        // CHECK-DAG: %[[RESULT:.+]] = llvm.call %[[LOADEDPTR]](%[[ERASEDPTR]], %[[CST1]]) : (!llvm.ptr, i32) -> i32
...
module @check_2captureArgs {
    ...
    func.func @main() {
        ...
        // CHECK-DAG: %[[STOREPTR:.+]] = llvm.bitcast %[[ALLOC]] : !llvm.ptr<i8> to !llvm.ptr<struct<([[FPTR]], struct<(i8, i32)>)>>
...
module @check_0captureArg {
    ...
    func.func @main() {
        ...
        // CHECK-DAG: %[[STOREPTR:.+]] = llvm.bitcast %[[ALLOC]] : !llvm.ptr<i8> to !llvm.ptr<struct<([[FPTR]], struct<()>)>>
