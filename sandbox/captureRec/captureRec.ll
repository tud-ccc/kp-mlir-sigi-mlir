...
define private void @closure_drop_0(ptr %0) {
  %2 = getelementptr { ptr, i32, ptr, { ptr } }, ptr %0, i32 0, i32 1
...
define private ptr @closure_wrapper_1(ptr %0, ptr %1) {
  %3 = getelementptr { ptr, i32, ptr, { ptr } }, ptr %0, i32 0, i32 1
...
define private ptr @closure_wrapper_0(ptr %0, ptr %1) {
  %3 = getelementptr { ptr, i32, ptr, {} }, ptr %0, i32 0, i32 1
...
define ptr @__main__(ptr %0) {
  ...
  store { ptr, i32, ptr, {} } { ptr @closure_wrapper_0, i32 1, ptr @closure_drop_nothing, {} undef }, ptr %2, align 8
  ...
  %5 = insertvalue { ptr, i32, ptr, { ptr } } { ptr @closure_wrapper_1, i32 1, ptr @closure_drop_0, { ptr } undef }, ptr %3, 3, 0
