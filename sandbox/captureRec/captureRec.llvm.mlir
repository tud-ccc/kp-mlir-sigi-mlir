!sigi_stackptr = !llvm.ptr<struct<"sigi_stack_t", opaque>>
module {
  llvm.func @closure_incr(!llvm.ptr)
  llvm.func private @closure_worker_1(%arg0: !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>, %arg1: !sigi_stackptr) -> !sigi_stackptr {
    llvm.call @sigi_push_closure(%arg1, %arg0) : (!sigi_stackptr, !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>) -> ()
    llvm.call @sigi_push_closure(%arg1, %arg0) : (!sigi_stackptr, !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>) -> ()
    llvm.return %arg1 : !sigi_stackptr
  }
  llvm.func private @closure_drop_0(%arg0: !llvm.ptr) {
    ...
    %1 = llvm.getelementptr %0[0, 1] : (!llvm.ptr<struct<(ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>, i32, ptr<func<void (ptr)>>, struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>)>>) -> !llvm.ptr<struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>>
  ...
  llvm.func private @closure_wrapper_1(%arg0: !llvm.ptr, %arg1: !sigi_stackptr) -> !sigi_stackptr {
    %0 = llvm.bitcast %arg0 : !llvm.ptr to !llvm.ptr<struct<(ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>, i32, ptr<func<void (ptr)>>, struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>)>>
    %1 = llvm.getelementptr %0[0, 1] : (!llvm.ptr<struct<(ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>, i32, ptr<func<void (ptr)>>, struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>)>>) -> !llvm.ptr<struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>>
    %2 = llvm.load %1 : !llvm.ptr<struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)>>
    %3 = llvm.extractvalue %2[0] : !llvm.struct<(ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)> 
    %4 = llvm.call @closure_worker_1(%3, %arg1) : (!llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>, !sigi_stackptr) -> !sigi_stackptr
    llvm.return %4 : !sigi_stackptr
  }
  llvm.func @sigi_push_closure(!sigi_stackptr, !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>)
  llvm.func @sigi_push_i32(!sigi_stackptr, i32)
  llvm.func private @closure_drop_nothing(%arg0: !llvm.ptr) {
    llvm.return
  }
  llvm.func private @closure_worker_0(%arg0: !sigi_stackptr) -> !sigi_stackptr {
    %0 = llvm.mlir.constant(1 : i32) : i32
    llvm.call @sigi_push_i32(%arg0, %0) : (!sigi_stackptr, i32) -> ()
    llvm.return %arg0 : !sigi_stackptr
  }
  llvm.func private @closure_wrapper_0(%arg0: !llvm.ptr, %arg1: !sigi_stackptr) -> !sigi_stackptr {
    ...
    %1 = llvm.getelementptr %0[0, 1] : (!llvm.ptr<struct<(ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>, i32, ptr<func<void (ptr)>>, struct<()>)>>) -> !llvm.ptr<struct<()>>
    %2 = llvm.call @closure_worker_0(%arg1) : (!sigi_stackptr) -> !sigi_stackptr
    llvm.return %2 : !sigi_stackptr
  }
  ...
  llvm.func @sigi_pop_closure(!sigi_stackptr) -> !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>
  llvm.func @apply(%arg0: !sigi_stackptr) -> !sigi_stackptr attributes {sym_visibility = "private"} {
    %0 = llvm.call @sigi_pop_closure(%arg0) : (!sigi_stackptr) -> !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>
    ...
    %3 = llvm.call %1(%2, %arg0) : !llvm.ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>, (!llvm.ptr, !sigi_stackptr) -> !sigi_stackptr
    llvm.call @closure_check_drop(%2) : (!llvm.ptr) -> ()
    llvm.return %3 : !sigi_stackptr
  }
  llvm.func @__main__(%arg0: !sigi_stackptr) -> !sigi_stackptr {
    ...
    llvm.call @sigi_push_closure(%arg0, %12) : (!sigi_stackptr, !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>) -> ()
    %13 = llvm.call @sigi_pop_closure(%arg0) : (!sigi_stackptr) -> !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>
    ...
    llvm.call @sigi_push_closure(%arg0, %27) : (!sigi_stackptr, !llvm.ptr<ptr<func<ptr<struct<"sigi_stack_t", opaque>> (ptr, ptr<struct<"sigi_stack_t", opaque>>)>>>) -> ()
    %28 = llvm.call @apply(%arg0) : (!sigi_stackptr) -> !sigi_stackptr
    llvm.return %28 : !sigi_stackptr
  }
  llvm.func @main() {
    %0 = llvm.mlir.constant(128 : i64) : i64
    %1 = llvm.call @malloc(%0) : (i64) -> !llvm.ptr
    llvm.call @sigi_init_stack(%1) : (!llvm.ptr) -> ()
    %2 = llvm.bitcast %1 : !llvm.ptr to !sigi_stackptr
    %3 = llvm.call @__main__(%2) : (!sigi_stackptr) -> !sigi_stackptr
